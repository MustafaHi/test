...
// router.MATCH_REGEXP_FLAGS = 'i';
// var MD = window.markdownit({html: true, linkify: true, highlight: function (str, lang) {
//     if (lang && hljs.getLanguage(lang))
//       try { return hljs.highlight(lang, str).value; } catch (__) {}
...
iSearch.addEventListener("input", () => {
	// console.log(Page[1].find(e => e.t.indexOf(this.value) >= 0));
	console.log(iSearch.value);
	if (iSearch.value.length > 0) find(iSearch.value, Page[1]);
});
